              ...
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen">
                    <span className="notfound_text">Speak To Crypto</span>
                  </div>
                </div>
              </div>
            </div>
...
const StyledWrapper = styled.div`
  /* Design Inspired by Stefan Devai */
  position: absolute;
  right: -30%;
  top: -45%;
  transform: scale(2.55); /* 3x bigger than original scale(0.85) */
  z-index: 10;
  ...
  .main {
    ...
    justify-content: center;
    margin-top: 5em;
    transform: scale(3.6); /* 3x bigger than original scale(1.2) */
  }
  ...
  @media (max-width: 1024px) {
    right: -40%;
    top: -30%;
    transform: scale(2.1); /* 3x bigger than original scale(0.7) */
  }
  ...
  @media (max-width: 768px) {
    ...
    right: auto;
    top: auto;
    transform: scale(1.8); /* 3x bigger than original scale(0.6) */
    margin-top: -6rem;
  }
`;
